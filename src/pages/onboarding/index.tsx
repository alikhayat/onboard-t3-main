...
export default function OnboardingInfo(props: OnboardingInfoProps) {
  ...
  const createOnboarding = trpc.onboarding.createOnboarding.useMutation({
    onSuccess: async (data: any) => {
      console.log("Onboarding created");
      console.log(data);
      await utils.onboarding.invalidate();
      router.push(`/onboarding/${data.id}/personal-info`);
    },
    onError: () => {
                    ...
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 h-48 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <Combobox
                          ...
                          onChange={(e: any) => {
                            if (e?.id) {
                              router.push(`/onboarding/${e.id}/personal-info`);
                            }
                          }}
                        >
