...
const recentPosts = [
  { id: 1, name: "Boost your conversion rate" },
  {
    id: 2,
    name: "How to use search engine optimization to drive traffic to your site",
  },
  { id: 3, name: "Improve your customer experience" },
];
          ...
          <div className="flex items-center justify-between py-6 md:justify-start md:space-x-10">
            ...
            {session ? (
              ...
              <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                ...
                <a className="ml-8 inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
                  Sign up
                </a>
              </div>
            )}
          ...
          <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
            ...
            <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <a className="flex w-full items-center justify-center rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-indigo-600 hover:bg-gray-50 md:py-4 md:px-10 md:text-lg">
                  Live demo
                </a>
              </div>
            </div>
